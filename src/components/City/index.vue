    ...
    methods : {
        formatCityList(cities){
              ...
              for(var i=0;i<cities.length;i++){
                if(cities[i].pinyin === "Beijing" ||
                    cities[i].pinyin === "Shanghai"||
                    cities[i].pinyin === "Shenzhen"||
                    cities[i].pinyin === "Chongqing" ||
                    cities[i].pinyin === "Chengdu"||
              ...
              for(var i=0;i<cities.length;i++){
                  ...
                  if(toCom(firstLetter)){  //新添加index
                      cityList.push({ index : firstLetter , list : [ { nm : cities[i].name , id : cities[i].label } ] });
                  }
                  else{   //累加到已有index中
                      for(var j=0;j<cityList.length;j++){
                          if( cityList[j].index === firstLetter ){
                              cityList[j].list.push( { nm : cities[i].name , id : cities[i].label } );
                          }
                      }
                  }
              }
